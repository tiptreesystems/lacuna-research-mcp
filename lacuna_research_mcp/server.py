...
SERVER_INSTRUCTIONS = (
    ...
    "Works, papers, research directions (clusters), authors, venues, institutions, and "
    ...
    "details. Use get_work for Work results and get_paper for specific versions. "
    "When a Lacuna entity materially informs an answer, cite its "
    ...
    "\n\nDetail tools: get_work, get_paper, get_direction and get_direction_papers, "
