...
SERVER_INSTRUCTIONS = (
    ...
    "details. For conferences commonly known by an acronym, search using the "
    "standard acronym (for example, NeurIPS, ICML, ICLR, CVPR, or ACL); expanded "
    "conference names may not be indexed. All tools are read-only and never "
    "mutate state."
